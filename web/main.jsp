...
<head>
    ...
    <script type="text/javascript">
        function selPage_onchange(){
            ...
            location.href="main.do?page="+pageNum;
        }
    </script>
</head>
                    ...
                    <table class="table_context">
                      ...
                      <%--  <%
                        ...
                        <%
                            ...
                            Page<Contracts> pageBean= (Page) request.getAttribute("pageBean");
                        %>
                            ...
                            <%} %>--%>
                             <c:choose>
                                 <c:when test="${pageBean.pageNum>1}">
                                     <a href="main.do?page=1">第一页</a>&nbsp;&nbsp;
                                     <a href="main.do?page=${pageBean.pageNum-1}">上一页</a>
                                 </c:when>
                                <c:otherwise>
                                    第一页&nbsp;&nbsp;上一页&nbsp;&nbsp;
                                </c:otherwise>
                                ...
                                <c:choose>
                                    <c:when test="${pageBean.pageNum<pageBean.totalPage}">
                                        <a href="main.do?page=${pageBean.pageNum+1}">下一页</a>&nbsp;&nbsp;
                                        <a href="main.do?page=${pageBean.totalPage}">最后一页</a>
                                    </c:when>
                                    <c:otherwise>
                                        下一页&nbsp;&nbsp;最后一页&nbsp;
                                    </c:otherwise>
